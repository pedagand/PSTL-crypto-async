use crate::{Cell, Scheduler, resultIndex};
...
pub fn submit_job(buf: Arc<Mutex<Vec<Cell>>>, scheduler: Arc<Scheduler>, size: usize,
...
pub fn test_submit_job(buf: Arc<Mutex<Vec<Cell>>>, scheduler: Arc<Scheduler>, size: usize,
