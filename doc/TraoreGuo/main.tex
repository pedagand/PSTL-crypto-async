...
\lstset{language=Rust,style=boxed,extendedchars=false}
...
\lstinputlisting[ firstline=14, lastline=30]{main.rs}
...
\lstinputlisting[ firstline=116, lastline=143]{main.rs}
